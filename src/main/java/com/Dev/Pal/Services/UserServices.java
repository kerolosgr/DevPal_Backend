    ...
    public HashMap<String, Object> saveUserOrRetrieve(ResponseEntity<String> response, MultipartFile cv) throws IOException {
        ...
        if (user == null) {
            ...
            try {
                ...
                newUser.setResume_score(nlp.getResume_score());
                newUser.setTechnical_Career_Tips(nlp.getTechnical_Career_Tips());
                newUser.setWeaknesses_in_Resume(nlp.getWeaknesses_in_Resume());
